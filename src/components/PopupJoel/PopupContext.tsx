    ...
    return (
        <div className={classNames(
            ...
            <div className={classes.headerContainer}>
                ...
                <BsX size={75} fill="white" color="white" className={classes.closeButton}
                    onClick={closePopup}
                />
            </div>
...
export function PopupContextProvider(props: {
    ...
    // create state
    const [popupDefControled, setPopupDefControled] = useState<popupDefControled>(initialState.popupDefControled);

    // create context provider
    return (
        <PopupContext.Provider value={{popupDefControled, setPopupDefControled}}>
            {popupDefControled.isInDom && <Popup popupDefControled={popupDefControled} />}
            <div className={classNames({
